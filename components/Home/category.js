      ...
      <Box sx={{ width: "100%" }}>
        <Box className={classes.categories}>
          ...
          >
            ...
            />
            <CustomTab
              label="Strategies & Business"
              {...a11yProps(2)}
              className={classes.categories}
            />
            <CustomTab
              label="Designers, Son & Image"
              {...a11yProps(3)}
              className={classes.categories}
            />
            <CustomTab
        ...
        <CustomTabPanel value={value} index={0}>
          ...
          <div className={classes.category}>
            ...
            <Typography className={classes.item}>Backend Developers</Typography>
            <Typography className={classes.item}>
              Frontend Developers
            </Typography>
            <Typography className={classes.item}>Data Scientists</Typography>
            <Typography className={classes.item}>Software Engineers</Typography>
            <Typography className={classes.item}>DevOps</Typography>
            <Typography className={classes.item}>Mobile Developers</Typography>
            <Typography className={classes.item}>
