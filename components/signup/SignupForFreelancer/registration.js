...
export default function SignupForFreelancer() {
  const loginBtn = {
      ...
      <div className={classes.container}>
        <div className={classes.leftForm}>
          ...
          <div className={classes.social}>
            ...
            <h3>Registration with Facebook</h3>
          </div>
          ...
          <form className={classes.message}>
            ...
            <Link href='/signup/freelancer/categorization' style={{textDecoration: 'none', fontSize: '16px'}}>Previous</Link>
